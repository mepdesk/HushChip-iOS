...
//
//  SatoText.swift  (Signstr Ghost typography — Outfit only)
//  Signstr
//
...
enum SatoTextStyle {
    ...
    case navTitle          // Outfit-Regular / 11pt / +5pt / uppercase / sgTextMuted
    case navButton         // Outfit-Regular / 10pt / +2pt / uppercase / sgTextMuted
    case sectionLabel      // Outfit-Regular /  9pt / +3pt / uppercase / sgTextMuted
    case cardTitle         // Outfit-Regular / 12pt /  0pt / none      / sgTextBody
    case body              // Outfit-Light   / 12pt /  0pt / none      / sgTextBody
    case onboardingHeading // Outfit-Light   / 16pt / +0.5pt / none    / sgTextBright
    case inputText         // Outfit-Light   / 13pt /  0pt / none      / sgTextBright
    case buttonText        // Outfit-Regular / 11pt / +4pt / uppercase / sgTextBright
    case tabBarLabel       // Outfit-Regular /  8pt / +1pt / uppercase / sgTextMuted
    case tagBadge          // Outfit-Regular /  9pt / +1pt / uppercase / sgTextMuted
    case counterText       // Outfit-Regular /  9pt / +1.5pt / uppercase / sgTextMuted

    // ── Legacy styles — backward compat, remapped to Ghost ───────────────
    case title             // → onboardingHeading  (Outfit-Light 16pt sgTextBright)
    ...
    case SKMenuItemSubtitle// → small body / sgTextMuted
    case SKStrongBodyDark  // → body / sgTextBody
    case SKStrongBodyLight // → body / sgTextBody
