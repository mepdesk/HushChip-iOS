...
//  Signstr — PIN confirmation screen (new card / PIN update)
            ...
            VStack(spacing: 0) {
                ...
                Button(action: handleConfirm) {
                    Text("CONFIRM")
                        ...
                        .tracking(4)
                        .foregroundColor(pinCodeConfirmation.count >= 4 ? .sgTextBright : .sgTextGhost)
                        .frame(maxWidth: .infinity)
                        .frame(height: 50)
                        .background(pinCodeConfirmation.count >= 4 ? Color.sgBorder : Color.sgBgSurface)
                        .cornerRadius(Dimensions.buttonCornerRadius)
                        .overlay(
                            RoundedRectangle(cornerRadius: Dimensions.buttonCornerRadius)
                                .stroke(pinCodeConfirmation.count >= 4 ? Color.sgBorderHover : Color.sgBorder,
                                        lineWidth: 1)
                        )
                }
