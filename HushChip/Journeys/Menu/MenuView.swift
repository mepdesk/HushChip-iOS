...
enum HushChipURL: String {
    case howToUse = "https://hushchip.co.uk"
    case terms = "https://hushchip.co.uk/terms"
    case privacy = "https://hushchip.co.uk/privacy"
    case sourceCode = "https://github.com/hushchip/HushChip-iOS"
    case licence = "https://github.com/hushchip/HushChip-iOS/blob/main/LICENCE"
                    ...
                    Button(action: {
                        ...
                        HStack(spacing: 10) {
                            ...
                            Text("\u{203A}")
                                ...
                                .foregroundColor(.hcDanger.opacity(0.5))
                        }
    ...
    var body: some View {
        HStack {
            Text(text)
                ...
                .tracking(3)
                .foregroundColor(isDanger ? .hcDanger.opacity(0.7) : .hcTextGhost)
            Spacer()
        }
    }
}
